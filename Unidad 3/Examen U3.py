class AlumnosT():
	def __init__(self, Edad, Nombre, calM, calC, calFI, calFP, calT, calE, calI, CalPre, Prom, Resid, Dist):
		self.Edad = Edad
		self.Nombre = Nombre
		self.calM = calM
		self.calC = calC
...
Melani = AlumnosT(18,"Melany", 7, 8, 7, 5, 9, 10, 7, 7.51, 9, "pabellon", 5)
Diego = AlumnosT(19,"Diego", 8, 9, 9, 10, 8, 8, 10, 8.85, 10, "rincón", 13) 
...
Alejandro= AlumnosT(19, "Alejandro", 10, 9, 8, 9, 8, 9, 8, 8.71 ,9, "Ejido Fresnillo", 17)
...
P = (10+7+5+10+10+9+10+9+9+9+9+9+9+9+8)/(15)

print("Alumnos mayores: ", Alexis.Nombre, ":", Alexis.Edad, " ", Areli.Nombre, ":", Areli.Edad, " ", Alejandro.Nombre,
	":", Alejandro.Edad," ", Diego.Nombre, ":", Diego.Edad," ", Isaac.Nombre, ":", Isaac.Edad)
